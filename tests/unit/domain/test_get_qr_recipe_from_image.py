...
class TestGetQRRecipeFromImage:
    def test_decodes_colour_card_fixture(self):
    ...
    def test_decodes_monochromatic_card_fixture(self):
    ...
    def test_parses_name_when_payload_includes_it(self, tmp_path):
    ...
    def test_leaves_name_as_none_when_payload_omits_it(self, tmp_path):
    ...
    def test_raises_qr_not_found_for_missing_file(self):
    ...
    def test_raises_qr_not_found_for_image_without_qr(self):
    ...
    def test_raises_invalid_json_when_qr_contains_non_json_text(self, tmp_path):
    ...
    def test_raises_invalid_json_when_qr_content_is_not_an_object(self, tmp_path):
    ...
    def test_raises_unsupported_version_when_v_is_missing(self, tmp_path):
        payload = _valid_payload()
        del payload["v"]
        path = _write_qr(tmp_path, json.dumps(payload))
    ...
    def test_raises_unsupported_version_when_v_is_not_one(self, tmp_path):
        payload = _valid_payload()
        payload["v"] = 2
        path = _write_qr(tmp_path, json.dumps(payload))
    ...
    def test_raises_unknown_fields_when_payload_has_unexpected_key(self, tmp_path):
        payload = _valid_payload()
    ...
    def test_raises_type_mismatch_when_int_field_has_string_value(self, tmp_path):
        payload = _valid_payload()
    ...
    def test_raises_type_mismatch_when_required_field_is_missing(self, tmp_path):
        payload = _valid_payload()
