...
urlpatterns = [
    ...
    path("images/import/partial/suggest/", views.import_folder_suggest_view, name="import-folder-suggest"),
    path("images/import/", views.ImportFolder.as_view(), name="import-folder"),
